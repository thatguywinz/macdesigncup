...
export default function CupFigure({ progress: p, enter: e, className }: CupFigureProps) {
  ...
  return (
    ...
    >
      ...
      <m.g data-cup="end" style={{ opacity: gridO }}>
      ...
      <m.g data-cup="end" style={{ opacity: spotO }}>
        <SpotCone id={id} />
      ...
      <m.g data-cup="end" style={{ opacity: plinthO }}>
        <PlinthFill id={id} />
      </m.g>
      ...
      <m.g data-cup="end" style={{ opacity: poolO }}>
        <SpotPool id={id} />
      </m.g>

      {/* ── Stage 4: the presentation frame ── */}
      <m.g data-cup="mid" style={{ opacity: presentO }}>
      ...
      <m.g data-cup="mid" style={{ opacity: crossO }}>
      ...
      <g ref={cupRef} data-cup="move">
        ...
        <m.g data-cup="mid" style={{ opacity: backO }}>
          <path d={`${RINGS_BACK} ${MERIDIANS_BACK}`} fill="none" className="stroke-bone/25" strokeDasharray="3 5" />
        </m.g>

        {/* Stage 4: the render */}
        <m.g data-cup="end" style={{ opacity: renderO }}>
          <CupRender id={id} />
        </m.g>

        <m.g data-cup="mid" style={{ opacity: wireO }}>
      ...
      <m.g data-cup="mid" style={{ opacity: tagO }}>
